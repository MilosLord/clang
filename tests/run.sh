...
#   ./tests/run.sh
# Zahteva: clang-format, clang-tidy, python3, git, c++ (za SampleTest).
...
grep -q 'Active profile: \*\*std\*\*' "$r/AGENTS.md" && ! grep -q '{{PROFILE}}' "$r/AGENTS.md" "$r/CLAUDE.md" && ok "AGENTS/CLAUDE placeholder zamenjen" || bad "placeholder"
